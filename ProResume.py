...
# st.set_page_config(
#    page_title="ProResume",
# #    page_icon='./Logo/Proo.png',
# )
def run():
    # img = Image.open('./Logo/Prook.png')
    ...
    if choice == 'User':
        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                # Safely retrieve fields using get() with a default value of 'N/A'
                ...
                if name == 'N/A':
                    st.text('Name is missing in the resume.')
                    name = st.text_input('Please enter your name:')
                else:
                    st.text('Name: ' + name)

                if email == 'N/A':
                    st.text('Email is missing in the resume.')
                    email = st.text_input('Please enter your email:')
                else:
                    st.text('Email: ' + email)

                if mobile_number == 'N/A':
                    st.text('Mobile Number is missing in the resume.')
                    mobile_number = st.text_input('Please enter your mobile number:')
                else:
                    st.text('Contact: ' + mobile_number)
